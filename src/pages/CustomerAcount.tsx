          ...
          <div className="md:col-span-3">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-8">
                ...
                />
                <div>
                  <h2 className="font-semibold text-gray-900">{user?.name || 'Guest'}</h2>
                  <p className="text-sm text-gray-500">{user?.customer ? 'Premium Member' : 'Visitor'}</p>
                </div>
              </div>
              <nav className="space-y-2">
                ...
                <button onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-2 text-red-600 hover:bg-red-50 rounded-lg cursor-pointer">
